...
// window.__api = "http://192.168.1.124:6066" ;
// window.__api = "http://192.168.1.164:8080/gms" ;
window.__api = "http://192.168.1.192:9999/gms" ;			// 本地环境/
// window.__api = "http://gmsmall.gmsweipai.com:9999/gms" ;	// 正式环境
// window.__api = "http://192.168.1.10:8080" ;
window.__cache_ver = Date.now() ; // 缓存版本 < 可配置 >
window.__sepui_path = "http://192.168.1.124:100" ;  // sepui 的远程路径 < 可配置 >
// window.__sepui_path = "http://library.sepui.com" ;  // sepui 的远程线上地址
