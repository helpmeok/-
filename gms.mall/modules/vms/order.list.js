define(function(require, exports, module) {
    module.exports = function(tpl, view, stc, svc) {
        require('../styles/order.list.css') ; // 载入 css 样式表
        var _vm = null ;
        tpl.m_on("init", function() {
            _vm = tpl.m_vm({
                ...
                methods : {
                    ...
                    //             goodsImages : _item.goodsImages,
                    //             goodsName : _item.goodsName,
                    //             goodsPrice : _item.orderPrice,
                    //             goodsFreight : _item.freight,
                    //             num : _item.num,
                    //             orderNo : _item.orderNo,
                    //             serialNo : _item.serialNo,
                    //             flag : 1 // 表示需要去支付
                    //         } ;
                    //         list.push(_data) ;
                    //     }
